...
class TimeQuestions{
  ...
  timeQuestion() {
    ...
    if (question == hour) {
      ...
      String _botAnswer = kakoBot + ' Opa! são : ${date.hour} horas e ${date.minute} minutos e ${date.second} segundos!';
      print(_botAnswer);
  ...
  unsure() {
    if (question.contains('horas') || question.contains('Horas')) {
      ...
      if (answer.contains('Sim') || answer.contains('sim')) {
        ...
        String _botAnswer = kakoBot + ' Beleza, são : ${date.hour} horas e ${date.minute} minutos e ${date.second} segundos!';
        print(_botAnswer);
      } else {
